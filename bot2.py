...
# === KONFIGURATSIYA ===
BOT_TOKEN = "8499840750:AAH-91HJeq4KIog6VfQQnSRB53tUEstNuQU"
ADMIN_CHAT_ID = 6932881775
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"🤖 <b>Murojaat va Reklama Botiga</b> xush kelibsiz!\n\n"
        f"📊 Bizning xizmatlarimiz:\n"
        f"• Instagram reklama\n"
        f"• Telegram reklama\n"
        f"• Instagram + Telegram  reklama paketlar\n\n"
